module.exports = {
  VERSION: 'v1.0.0',
  owner: process.env.SUDO || "6288271609722,0",
  ...
  ownername: process.env.OWNER_NAME || "Fazi",
  prefix: process.env.PREFIX || ".",
  MENU: process.env.MENU_BOT || "Fzii bots;6288271609722;",
  logs: ToBool(process.env.LOG_MSG) || true,
  bot_name: process.env.BOT_NAME || "Fzii",
